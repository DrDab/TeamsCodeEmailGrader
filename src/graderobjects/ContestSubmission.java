...
public class ContestSubmission
{
    ...
    public ContestSubmission(long id, long uid, String senderEmail, long date, String subject, String body,
        SubmissionState state, ContestDivision contestDivision, String teamName, ProblemDifficulty problemDifficulty,
        ProgrammingLanguage programmingLanguage, String miscInfo)
    {
        this.id = id;
        this.uid = uid;
    ...
    {
        this(id, uid, senderEmail, date, subject, body, state, null, null, null, null, null);
    }
}
